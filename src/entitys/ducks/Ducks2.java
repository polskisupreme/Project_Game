...
public class Ducks2 extends GameObjects implements EntityEnemy {
    ...
    public Ducks2(double x, double y, SpriteTextures textures, Controller controller, GameEngine gameEngine){
        super(x, y);
        this.gameEngine = gameEngine;
        this.controller = controller;

        animation = new Animation(4, textures.ducks2[0], textures.ducks2[1], textures.ducks2[2]);
    }
    ...
    public void update() {
        ...
        for (int i = 0; i <gameEngine.entityPlayer.size(); i++) {
            ...
            if (Physisc.collision(this, tempEnt) && HP == 2){
