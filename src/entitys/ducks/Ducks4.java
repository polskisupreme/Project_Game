...
public class Ducks4 extends GameObjects implements EntityEnemy {
    ...
    public Ducks4(double x, double y, SpriteTextures textures, Controller controller, GameEngine gameEngine){
        super(x, y);
        this.gameEngine = gameEngine;
        this.controller = controller;

        animation = new Animation(4, textures.ducks4[0], textures.ducks4[1], textures.ducks4[2]);
    }
    ...
    public void update() {
        ...
        for (int i = 0; i <gameEngine.entityPlayer.size(); i++) {
            ...
            if (Physisc.collision(this, tempEnt) && HP == 4) {
                controller.removeEntity(tempEnt);
                HP--;
            }else  if (Physisc.collision(this, tempEnt) && HP == 3){
                controller.removeEntity(tempEnt);
                HP--;
